              ...
              <table className="plan-grid-table">
                <tbody className="plan-grid-tbody">
                  <tr>
                    ...
                    <td className="plan-grid-string">9,500원</td>
                    <td className="plan-grid-string">13,500원</td>
                    <td className="plan-grid-string">17,000원</td>
                  </tr>
                  <tr>
                    <td className="plan-grid-feature">
                      <div>영상 화질</div>
                    </td>
                    <td className="plan-grid-string">
                      <div>좋음</div>
                    </td>
                    <td className="plan-grid-string">
                      <div>매우 좋음</div>
                  ...
                  <tr>
                    ...
                    <td className="plan-grid-boolean">
                      <span>
                        <CheckMark />
                      </span>
                    </td>
